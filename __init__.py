...
class Plugin(QObject):
    ...
    def _onSettingsDialogAboutToExecute(self, dialog):
        ...
        # try to get Lint
        try:
            settingsPage = dialog._itemByPath(['Lint'])
        except IndexError:
            settingsPage = dialog.createSettingsPage("Lint Settings")
            #dialog.appendPage("Lint")
            dialog.appendPage("Lint", settingsPage, icon)
